...
import main.Start;
import student.Course.CourseViewStudent;
...
public class StudentStart extends JFrame {
	...
	public static student.Course.CourseViewStudent course_view_frame = null;
	...
	public StudentStart() {
		...
		btn2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				course_view_frame = new student.Course.CourseViewStudent();
