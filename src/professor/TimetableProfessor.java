...
public class TimetableProfessor extends JFrame{
	...
	private void showTable(Panel[][] pArr) {
		...
		try {
			...
			pStmt.setInt(1, Integer.parseInt(Professor.getInstance().getProfessorId()));
			pStmtname.setInt(1, Integer.parseInt(Professor.getInstance().getProfessorId()));
