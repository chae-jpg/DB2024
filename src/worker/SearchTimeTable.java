...
public class SearchTimeTable extends JFrame{
	//JDBC driver name and database URL
		...
		static WorkerStart start_frame = null;
	private Panel mon12;
	private Panel fri56;
	private Panel fri45;
	private Panel fri34;
	...
	public SearchTimeTable() {
		...
		studentIDinput.setText("학번을 입력하세요");
		studentIDinput.setBounds(251, 86, 369, 21);
		getContentPane().add(studentIDinput);
		studentIDinput.setColumns(10);
		
		searchBtn = new JButton("검색");
		
		searchBtn.setBounds(630, 84, 97, 23);
		getContentPane().add(searchBtn);
		
		title = new JLabel("");
		title.setFont(new Font("굴림", Font.PLAIN, 20));
		title.setBounds(251, 39, 369, 37);
		...
		searchBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int sid = Integer.parseInt(studentIDinput.getText());
				showTable(pArr, sid);
			}
		});
	...
	private void showTable(Panel[][] pArr, int sid) {
